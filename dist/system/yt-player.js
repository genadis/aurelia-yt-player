System.register(['aurelia-framework', 'aurelia-event-aggregator'], function (_export) {
  ...
  var inject, customAttribute, LogManager, EventAggregator, YTPlayerCustomAttribute, PlayerAPI;
  ...
  return {
    ...
    execute: function () {
      YTPlayerCustomAttribute = (function () {
        ...
        YTPlayerCustomAttribute = customAttribute('yt-player')(YTPlayerCustomAttribute) || YTPlayerCustomAttribute;
        YTPlayerCustomAttribute = inject(Element, EventAggregator, LogManager)(YTPlayerCustomAttribute) || YTPlayerCustomAttribute;
        return YTPlayerCustomAttribute;
      })();

      _export('YTPlayerCustomAttribute', YTPlayerCustomAttribute);
